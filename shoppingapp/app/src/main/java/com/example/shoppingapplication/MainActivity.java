...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        User john = null; //Testing
        try {
            john = new User(4, "john", false, RTools.encrypted("12345"));
        ...
        User alina = null; //Testing
        try {
            alina = new User(5, "Alina", false, RTools.encrypted("12345"));
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
        }
        ...
        //This whole wrapping is an observer. If you are not a LiveData user and you don't know what
        //you are doing. Better stay away. Whatever happens inside an observer stays there, and good luck
        //with the scope after that.
